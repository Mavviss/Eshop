...
namespace Eshop.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            ViewBag.NameAccount  = invoice.Account.FullName;
			ViewBag.ShippingAddress= invoice.ShippingAddress;
            ViewBag.EmailAccount = invoice.Account.Email;
            ViewBag.PhoneAccount=invoice.Account.Phone;
            ViewBag.Code = invoice.Code;
            ViewBag.IssuedDate = invoice.IssuedDate;
